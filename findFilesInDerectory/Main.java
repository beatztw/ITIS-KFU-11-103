...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        String dir = "C:\\Users\\alex1\\IdeaProjects\\untitled\\src\\Ex1";
        String ext = ".java";
        ...
        if(dir.isDirectory()){
            ...
            if(listFiles.length == 0){
                ...
                for(File f : dir.listFiles()){
                    ...
                    System.out.println("Файл найден: " + wayToFile);
                    sum += getWordCount(wayToFile);
                }
                System.out.println("Sum of lines of all files: " + sum);
            }
    ...
    public static class MyFileNameFilter implements FilenameFilter {
        ...
        public static int getWordCount(String filename) throws FileNotFoundException {
